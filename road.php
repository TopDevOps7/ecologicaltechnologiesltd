...
<!-- Home Begin -->
<section id="road" class="green-wave-gold page-section py-0">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" id="flight" src="assets/images/slider/road1.jpg" alt="First slide" />
                <div class="text-group">
                    <p>ROAD</p>
                    <p>We can find the right solution for your application from our broad range of products!</p>
                </div>
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" id="trucks" src="assets/images/slider/road2.jpg" alt="Second slide" />
                <div class="text-group">
                    <p>ROAD</p>
                    <p>We can find the right solution for your application from our broad range of products!</p>
                </div>
            ...
            <div class="carousel-item">
                <img class="d-block w-100" id="space" src="assets/images/slider/road3.jpg" alt="Third slide" />
                <div class="text-group">
                    <p>ROAD</p>
                    <p>We can find the right solution for your application from our broad range of products!</p>
                </div>
            ...
            <div class="carousel-item">
                <img class="d-block w-100" id="yachts" src="assets/images/slider/trucks.jpg" alt="yachts slide" />
                <div class="text-group">
                    <p>ROAD</p>
                    <p>We can find the right solution for your application from our broad range of products!</p>
                </div>
    ...
    <div class="content-section">
        <div class="container text-center">
            <div class="header_text">
                <p>Sandwich panels from Ecological Technologies are used in the complete bodywork of commercial
                    vehicles. We use an optimized mix of different panel types to find the best solution for your
                    application. A truck body made with these panels allows a rise in load capacity with a simultaneous
                    rise in rigidity of the cargo box. In addition, this construction material provides the following
                    advantages:
                </p>
                <p>It is resistant to corrosion, recyclable, can be varnished and is versatile in application – thus
                    proving ideal for light-weight truck bodyworks. We produce panels up to 15m long and 2.5m wide
                    without a butt-joint.
                </p>
                <p>We have substantial experience in the field of specialized vehicles, especially trucks or caravans
                    which are only built once or in smaller series. Ecological Technologies can support you during the
                    construction of your vehicle and together we will find the best composite materials solution for
                    your project.
                </p>
                <p>Beside superstructure parts, we can offer parts for loading ramps, interior parts, container parts,
                    and pre–formed or pre-assembled parts for special vehicles.
                </p>
                <p>
                    With the use of Ecological Technologies lightweight products with chromated and anodized anti-slip
                    surfaces, you solve many problems at once. The panels are easy to clean and easy to repair in case
                    of damage. Standard accessories like locks, inserts or hinges can be provided. Complete sidewalls or
                    partitions with thread plate panels can be delivered within a few weeks upon request.
                </p>
                <p>
                    A wide range of sheet material can be used as facings for lamination to our honeycomb core. Beside
                    aluminum, we are also able to use steel, PVC, GRP, wood-based sheets, cellulose fiber, HPL and many
                    more.
                </p>
            </div>
            <div class="content">
...
$(function() {
    ...
    $("#flight").addClass("zoomin")
    $('a[href="road.php"]').parent().parent().parent().addClass("active");
    $('a[href="road.php"]').parent().siblings().removeClass("active");
    $('.carousel').carousel({
        interval: false,
        ride: true
    })
