...
<head>
  ...
  <title>Investment #' . $this->invest['id'] . '</title>
  <style>
  </style>
</head>
<body>
                                      ...
                                      <tr>
                                        <td valign="top" class="m_6973222457317877454mcnTextContent"
                                          ...
                                          <p
                                            ...
                                            <br>
                                            Ihre Investition #' . $this->invest['id'] . ' wurde gerade bestätigt
                                          <br>
                                          <br>
                                          Mit Ihrer Hilfe wird die Welt schöner und sauberer.
                                          <br>
                                          <br>
                                          <hr>
