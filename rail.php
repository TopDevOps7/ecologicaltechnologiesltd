...
<!-- Home Begin -->
<section id="rail" class="green-wave-gold page-section py-0">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" id="flight" src="assets/images/slider/rail1.jpg" alt="First slide" />
                <div class="text-group">
                    <p>RAIL</p>
                    <p>We specialize in the design and production of advanced composites offering a high degree of
                        vertical integration: from a complex assembly group down to a simple sheet of honeycomb –
                        everything is possible.</p>
                </div>
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" id="trucks" src="assets/images/slider/rail2.jpg" alt="Second slide" />
                <div class="text-group">
                    <p>RAIL</p>
                    <p>We specialize in the design and production of advanced composites offering a high degree of
                        vertical integration: from a complex assembly group down to a simple sheet of honeycomb –
            ...
            <div class="carousel-item">
                <img class="d-block w-100" id="space" src="assets/images/slider/rail3.jpg" alt="Third slide" />
                <div class="text-group">
                    <p>RAIL</p>
                    <p>We specialize in the design and production of advanced composites offering a high degree of
                        vertical integration: from a complex assembly group down to a simple sheet of honeycomb –
            ...
            <div class="carousel-item">
                <img class="d-block w-100" id="yachts" src="assets/images/slider/rail4.jpg" alt="yachts slide" />
                <div class="text-group">
                    <p>RAIL</p>
                    <p>We specialize in the design and production of advanced composites offering a high degree of
                        vertical integration: from a complex assembly group down to a simple sheet of honeycomb –
    ...
    <div class="content-section">
        <div class="container text-center">
            <div class="header_text">
                <p>We are a leading global manufacturer of lightweight products primarily based on honeycomb core. We
                    specialize in the design and production of advanced composites offering a high degree of vertical
                    integration: from a complex assembly group down to a simple sheet of honeycomb – everything is
                    possible.
                </p>
                <p>Our products include various types of panels, formed and milled parts, and FRP components as well as
                    advanced drop-in parts suitable for a wide range of industries, but especially for the railway
                    industry.
                </p>
                <p>We are a leading global manufacturer of lightweight products primarily based on honeycomb core. We
                    specialize in the design and production of advanced composites offering a high degree of vertical
...
$(function() {
    ...
    $("#flight").addClass("zoomin")
    $('a[href="rail.php"]').parent().parent().parent().addClass("active");
    $('a[href="rail.php"]').parent().siblings().removeClass("active");
    $('.carousel').carousel({
        interval: false,
        ride: true
    })
