...
<!-- Home Begin -->
<section id="engineer" class="green-wave-gold page-section py-0">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" id="flight" src="assets/images/slider/engin1.jpeg" alt="First slide" />
                <div class="text-group">
                    <p>MECHANICAL ENGINEERING</p>
                    <p>Faster, more precisely, and with less energy consumption. Ecological Technologies will help you
                        to achieve these goals and ensure material efficiency and cost effectiveness.</p>
                </div>
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" id="trucks" src="assets/images/slider/enginer2.jpeg" alt="Second slide" />
                <div class="text-group">
                    <p>MECHANICAL ENGINEERING</p>
                    <p>Faster, more precisely, and with less energy consumption. Ecological Technologies will help you
                        to achieve these goals and ensure material efficiency and cost effectiveness.</p>
            ...
            <div class="carousel-item">
                <img class="d-block w-100" id="space" src="assets/images/slider/engin3.jpeg" alt="Third slide" />
                <div class="text-group">
                    <p>MECHANICAL ENGINEERING</p>
                    <p>Faster, more precisely, and with less energy consumption. Ecological Technologies will help you
                        to achieve these goals and ensure material efficiency and cost effectiveness.</p>
            ...
            <div class="carousel-item">
                <img class="d-block w-100" id="yachts" src="assets/images/slider/engin4.jpeg" alt="yachts slide" />
                <div class="text-group">
                    <p>MECHANICAL ENGINEERING</p>
                    <p>Faster, more precisely, and with less energy consumption. Ecological Technologies will help you
                        to achieve these goals and ensure material efficiency and cost effectiveness.</p>
    ...
    <div class="content-section">
        <div class="container text-center">
            <div class="header_text">
                <p>We analyze together with you the required properties. With this information we can design a variety
                    of possible combinations of covering skins, core materials and attachments to create the best
                    product to meet your needs.
                </p>
                <p>Our most significant product advantage is weight reduction while preserving mechanical properties.
                    This leads to lower energy costs, less vibration, faster line speeds, and improved positioning
                    accuracy.
                </p>
                <p>We deliver tailored solutions just-in-time and in the highest quality!
                </p>
            </div>
            <div class="content">
                <p>
            ...
            <div class="product_section">
                <h2>Mechanical Engineering Products
                </h2>
            ...
            <div class="product_section">
                <h2>Mechanical Engineering Technologies</h2>
...
$(function() {
    ...
    $("#flight").addClass("zoomin")
    $('a[href="engineer.php"]').parent().parent().parent().addClass("active");
    $('a[href="engineer.php"]').parent().siblings().removeClass("active");
    $('.carousel').carousel({
        interval: false,
        ride: true
    })
