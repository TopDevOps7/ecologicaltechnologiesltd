...
<!-- Home Begin -->
<section id="ship" class="green-wave-gold page-section py-0">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" id="flight" src="assets/images/slider/yachts.jpg" alt="First slide" />
                <div class="text-group">
                    <p>SHIP/YACHT BUILDING</p>
                    <p>We deliver tailored solutions just-in-time and in the highest quality!</p>
                </div>
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" id="trucks" src="assets/images/slider/ship1.jpg" alt="Second slide" />
                <div class="text-group">
                    <p>SHIP/YACHT BUILDING</p>
                    <p>We deliver tailored solutions just-in-time and in the highest quality!</p>
                </div>
            ...
            <div class="carousel-item">
                <img class="d-block w-100" id="space" src="assets/images/slider/ship2.jpg" alt="Third slide" />
                <div class="text-group">
                    <p>SHIP/YACHT BUILDING</p>
                    <p>We deliver tailored solutions just-in-time and in the highest quality!</p>
                </div>
            ...
            <div class="carousel-item">
                <img class="d-block w-100" id="yachts" src="assets/images/slider/ship3.jpg" alt="yachts slide" />
                <div class="text-group">
                    <p>SHIP/YACHT BUILDING</p>
                    <p>We deliver tailored solutions just-in-time and in the highest quality!</p>
                </div>
    ...
    <div class="content-section">
        <div class="container text-center">
            <div class="header_text">
                <p>Ecological Technologies panels can be used for interior design as well as for structural applications
                    in ship and yacht building. In interior applications, we can provide you with floor panels, side
                    panels, ceiling panels, doors, bulkheads, toilet and separation units. For supporting parts, we can
                    manufacture floors, walls and roof panels according to your requirements. Significant weight savings
                    are possible with our products.
                </p>
            </div>
            <div class="content">
                <p>
            ...
            <div class="product_section">
                <h2>Ship & Yacht Building Products
                </h2>
            ...
            <div class="product_section">
                <h2>Ship & Yacht Building Technologies</h2>
...
$(function() {
    ...
    $("#flight").addClass("zoomin")
    $('a[href="ship.php"]').parent().parent().parent().addClass("active");
    $('a[href="ship.php"]').parent().siblings().removeClass("active");
    $('.carousel').carousel({
        interval: false,
        ride: true
    })
