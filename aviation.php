...
<!-- Home Begin -->
<section id="space" class="green-wave-gold page-section py-0">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="text-group">
                    <p>AVIATION</p>
                    <p>Providing the Aviation Industry with high quality composite materials.</p>
                </div>
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" id="trucks" src="assets/images/slider/Aviation_F01-1024x527-1.jpg"
                    alt="Second slide" />
                <div class="text-group">
                    <p>AVIATION</p>
                    <p>Providing the Aviation Industry with high quality composite materials.</p>
            ...
            <div class="carousel-item">
                <img class="d-block w-100" id="space" src="assets/images/slider/slide2-bg-1024x397-1.jpg"
                    alt="Third slide" />
                <div class="text-group">
                    <p>AVIATION</p>
                    <p>Providing the Aviation Industry with high quality composite materials.</p>
            ...
            <div class="carousel-item">
                <img class="d-block w-100" id="yachts" src="assets/images/slider/slide1-bg-1024x813-1.jpg"
                    alt="yachts slide" />
                <div class="text-group">
                    <p>AVIATION</p>
                    <p>Providing the Aviation Industry with high quality composite materials.</p>
    ...
    <div class="content-section">
        <div class="container text-center">
            <div class="header_text">
                <p>We combine a broad range of raw materials to create high quality composite materials. Low weight
                    means
                    lower operating costs, higher payload, greater speed, reduced wear and therefore an increase in your
                    efficiency!
                </p>
            </div>
            <div class="content">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="image_item_area">
                                ...
                                <div class="button_field reduce">
                                    <p>EASA PART 21 CUSTOMIZED TRAINING COURSES​
                                    </p>
                                    <button type="button" class="btn btn-success" data-toggle="modal"
                                        data-target="#easa-logo">Information</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>Pre-finished parts according to your specifications!</p>
...
$(function() {
    ...
    $("#flight").addClass("zoomin")
    $('a[href="aviation.php"]').parent().parent().parent().addClass("active");
    $('a[href="aviation.php"]').parent().siblings().removeClass("active");
    $('.carousel').carousel({
        interval: false,
        ride: true
    })
