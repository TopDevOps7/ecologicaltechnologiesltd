...
<!-- Home Begin -->
<section id="architecture" class="green-wave-gold page-section py-0">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" id="flight" src="assets/images/product/aciture1.jpg" alt="First slide" />
                <div class="text-group">
                    <p>ARCHITECTURE</p>
                    <p>Our innovative products are perfect for designers and architects with vision!</p>
                </div>
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" id="trucks" src="assets/images/product/aciture2.jpg" alt="Second slide" />
                <div class="text-group">
                    <p>ARCHITECTURE</p>
                    <p>Our innovative products are perfect for designers and architects with vision!</p>
                </div>
            ...
            <div class="carousel-item">
                <img class="d-block w-100" id="space" src="assets/images/product/aciture3.jpg" alt="Third slide" />
                <div class="text-group">
                    <p>ARCHITECTURE</p>
                    <p>Our innovative products are perfect for designers and architects with vision!</p>
                </div>
            ...
            <div class="carousel-item">
                <img class="d-block w-100" id="yachts" src="assets/images/product/aciture4.jpg" alt="yachts slide" />
                <div class="text-group">
                    <p>ARCHITECTURE</p>
                    <p>Our innovative products are perfect for designers and architects with vision!</p>
                </div>
    ...
    <div class="content-section">
        <div class="container text-center">
            <div class="header_text">
                <p>Our products are ideally suited for use in interior décor due to their excellent mechanical
                    properties and diversity of possible application. Composites have been suspended as ceilings, and
                    used as translucent partitions, wall coverings and much more. Think of the possibilities!
                </p>
            </div>
            <div class="content">
                <p>
...
$(function() {
    ...
    $("#flight").addClass("zoomin")
    $('a[href="architecture.php"]').parent().parent().parent().addClass("active");
    $('a[href="architecture.php"]').parent().siblings().removeClass("active");
    $('.carousel').carousel({
        interval: false,
        ride: true
    })
