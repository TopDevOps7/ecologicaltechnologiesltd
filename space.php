...
<!-- Home Begin -->
<section id="aviation" class="green-wave-gold page-section py-0">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" id="flight" src="assets/images/slider/space-satellite.jpg"
                    alt="First slide" />
                <div class="text-group">
                    <p>SPACE</p>
                    <p>We participate right from the beginning in the development of new satellites, with universal
                        components.</p>
                </div>
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" id="trucks" src="assets/images/slider/space1.jpg" alt="Second slide" />
                <div class="text-group">
                    <p>SPACE</p>
                    <p>We participate right from the beginning in the development of new satellites, with universal
                        components.</p>
            ...
            <div class="carousel-item">
                <img class="d-block w-100" id="space" src="assets/images/slider/space2.jpg" alt="Third slide" />
                <div class="text-group">
                    <p>SPACE</p>
                    <p>We participate right from the beginning in the development of new satellites, with universal
                        components.</p>
            ...
            <div class="carousel-item">
                <img class="d-block w-100" id="yachts" src="assets/images/slider/space3.jpg" alt="yachts slide" />
                <div class="text-group">
                    <p>SPACE</p>
                    <p>We participate right from the beginning in the development of new satellites, with universal
                        components.</p>
    ...
    <div class="content-section">
        <div class="container text-center">
            <div class="header_text">
                <p>We at Ecological Technologies have acquired a high level of experience in composites, primarily for
                    the aerospace industry.
                </p>
                <p>Ecological Technologies started with honeycomb core production and has determinedly evolved into a
                    high-tech composite solutions provider. Our continuous broadening of the range of our products and
                    investment in production facilities has made us into a competitive business partner.
                </p>
                <p>We have been able to participate right from the beginning in the development of new satellites, the
                    creation of a new range of products, the acquisition of know-how during development and the
                    application of this knowledge to commercial products.
                </p>
            </div>
            <div class="content">
                <p>
            ...
            <div class="product_section">
                ...
                <div class="product_item">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="image_item_area">
                                <img src="assets/images/product/kevlar-hone.jpg" />
                                <div class="button_field">
                                    <p>Kevlar® Honeycomb</p>
                                    <button type="button" class="btn btn-success" data-toggle="modal"
                    ...
                    <div class="row productgroup">
                        ...
                        <div class="col-md-2">
                            <div class="image_item_area">
                                ...
                                <div class="button_field">
                                    <p>Panels With Alternative Cores
                                    </p>
                                    <button type="button" class="btn btn-success" data-toggle="modal"
            ...
            <div class="product_section">
                ...
                <div class="product_item">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="image_item_area">
                                <img src="assets/images/product/resin-transfer-molding.jpg" />
                                <div class="button_field">
                        ...
                        <div class="col-md-3">
                            <div class="image_item_area">
                                ...
                                <div class="button_field">
                                    <p>Resin Infusion</p>
                                    <button type="button" class="btn btn-success" data-toggle="modal"
                                        data-target="#resin-infusion">Information</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="image_item_area">
                                ...
                                <div class="button_field">
                                    <p>Clean Rooms </p>
                                    <button type="button" class="btn btn-success" data-toggle="modal"
                                        data-target="#clean-room-edit">Information</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
    ...
    <div class="modal fade" id="Kevlar®" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h2>Kevlar® Honeycomb</h2>
                    <p>ECK-core is a non-metallic, light-weight structural material mainly used as core element in
                        sandwich composite constructions.</p>
                    <p>For the production of this core para-aramide fibres calendered to a foil are coated with phenolic
                        resin.
                    </p>
                    <p>The ECK-core possesses extremely high strength-to-weight ratios. It is also electrically and
                        thermally insulating, chemically and corrosion as well as shock and fatigue resistant.
                    </p>
                    <p>The ECK-core is formable and self-extinguishing. These properties make ECK-core an ideal
                        construction material for light-weight applications.
                    </p>
                    <p>Typical applications in the aircraft industry are for vertical and horizontal stabilizers,
                        fairings, hatrack parts, wing parts, interiors, floorings, leading edges, gear doors and for
                        racing yachts and boats as structural parts.
                    </p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary">
    ...
    <div class="modal fade" id="covering" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h2>Panels With Alternative Covering Sheets</h2>
...
$(function() {
    ...
    $("#flight").addClass("zoomin")
    $('a[href="space.php"]').parent().parent().parent().addClass("active");
    $('a[href="space.php"]').parent().siblings().removeClass("active");
    $('.carousel').carousel({
        interval: false,
        ride: true
    })
