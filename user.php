  ...
  <div class="container ">
    ...
    <div class="row d-md-flex justify-content-md-around">
      <div class="col-md-5 col-12 popUpImg">
        <h1 class="amoount">€ <?php echo explode (",", number_format($value['investment'] , 1, ',', "."))[0]; ?></h1>
        ...
        <div class="popText d-flex justify-content-between pt-5">
          ...
          <div>
            ...
            <p>
              ...
              <?php } ?>
              <a download class="cert_link" href="utils/pdfGenerate.php?id=<?= $key ?>&passhash=<?= $hashValue ?>"
            ...
            <div class="d-flex justify-content-around mb-3 align-items-center">
              ...
              <div class="mt-4">
                <a href="clients/uploads/<?= $idFile ? $idFile['file_name'] : "" ?>"
                  ...
                  title="ID file download" id="id_file_download" download><i class="fas fa-download"></i></a>
              </div>
            </div>
            <div class="d-flex justify-content-around mb-3 align-items-center">
              <div class="form-group w-85" style="position: relative;">
            ...
            <div class="d-flex justify-content-around mb-3 align-items-center">
              ...
              <div class="mt-4">
                <a href="clients/uploads/<?= $ndaFile ? $ndaFile['file_name'] : "" ?>"
                  ...
                  title="NDA file download" id="nda_file_download" download><i class="fas fa-download"></i></a>
              </div>
            </div>
