            ...
            <div class="row ">
                ...
                <div class="col-sm-6">
                    <div class="form-group mb-4"><label for="user_password"
                            class="required form-label rd-input-label"><?= $ln['password'] ?></label><input
                            type="password" id="user_password" name="password" required class="form-input form-control">
                    </div>
                </div>
                <div class="col-sm-2">
                    <div class="form-group mb-4">
                        <label for="gender"
                            class="required form-label rd-input-label"><?= $ln['please_select'] ?></label>
                ...
                <div class="col-sm-5">
                    <div class="form-group mb-4"><label for="fname"
                            class="required form-label rd-input-label"><?= $ln['first_name'] ?></label><input
                            type="text" id="fname" name="userFname" required class="form-input form-control"></div>
                </div>
                <div class="col-sm-5">
                    <div class="form-group mb-4"><label for="lname"
                            class="required form-label rd-input-label"><?= $ln['last_name'] ?></label><input type="text"
                            id="lname" name="userLname" required class="form-input form-control"></div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group mb-4"><label for="address" class="required form-label rd-input-label">
                            <?= $ln['street_number'] ?></label><input type="text" id="address" name="userAddress"
                            required class="form-input form-control"></div>
                </div>
                <div class="col-sm-2">
                ...
                <div class="col-sm-6">
                    <div class="form-group mb-4"><label for="place" class="form-label rd-input-label">
                            <?= $ln['place'] ?></label><input type="text" id="place" name="userPlace"
                            class="form-input form-control">
                    </div>
                </div>
                <div class="col-sm-6">
