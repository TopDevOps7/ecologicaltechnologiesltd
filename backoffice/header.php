      ...
      <div class="container">
        <div class="dropdown">
          ...
          <div class="dropdown-menu">
            <a class="dropdown-item <?= $lang == "de" ? "active": "" ?>" data-lang='de' href="javascript:void(0);"><img
                src="../assets/images/flags/de.svg" alt="de"> German</a>
            <a class="dropdown-item <?= $lang == "en" ? "active": "" ?>" data-lang='en' href="javascript:void(0);"><img
                src="../assets/images/flags/en.svg" alt="en"> English</a>
          </div>
        </div>
      </div>
    </nav>
    <nav class="navbar navbar-expand-lg main-header">
      <div class="container">
        <a class="navbar-brand" href="../">
          <img src="../assets/images/logo.png" alt="Green Wave Materials" class="img-fluid">
        </a>
  ...
  <div class="mt-4" style="margin-left: 30px; margin-right:12.5px;">
    ...
    <div class="dropdown d-inline-block" id="users-btn">
      ...
      <ul class="dropdown-menu user-btn-list">
        <li class="<?= $page == "backoffice.php" ? "active" : "" ?>"><a href="backoffice.php">Backoffice</a></li>
        <hr class='m-0'>
    ...
    <a href="../utils/excelExport.php?user_id=<?= $user_id ?>" class="btn site-btn p-1 mr-4" style="float: right;"><i
        class="fa-solid fa-file-excel" style="margin-right: 8px;">
      </i> Export</a>
    <?php } ?>
    ...
    <a download href="../utils/zipGenerateAll.php" class="btn site-btn p-1" style="float: right; margin-right: 4px;"><i
        class="fas fa-file-zipper" style="margin-right: 8px;">
      </i>Export All</a>
    <br>
    <?php } ?>
