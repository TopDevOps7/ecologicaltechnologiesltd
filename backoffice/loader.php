...
<div class="container-fluid">
  ...
  <div class="st-head card-body">
    ...
    <h3 class="text-center"> Loader User List </h3>
    <div class="row">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content modal-content-centered">
      <div class="modal-header">
        <h3 class="modal-title" id="createAsinLabel">Create Loader</h3>
      ...
      <div class="modal-body">
        <form method="post" action="../utils/middle.php">
          ...
          <div class="form-group team_2-group">
            <label for="team_2">Team (Optional 2nd Team)</label>
...
<div class="modal fade" id="removeUserModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  ...
  <div class="modal-dialog" role="document" style="margin-top: 15%;">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title deactive-title" id="exampleModalLabel"><span class="block-user-desc-big"></span> Loader
          User?</h3>
        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
