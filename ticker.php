  ...
  <div class="d-lg-flex justify-content-md-around">
    <div class="userInfo d-flex align-items-center">
      ...
      <div class="userLeftInfo">
        ...
        <div class="grayLine"></div>
        <p class="activeStatus" style="margin: 10px;"><b>Investment</b> : <span id="investment_size">0 EUR</span>
        </p>
        <div class="grayLine"></div>
        <p class="activeStatus" style="margin: 10px;"><b>Performance</b> : <span id="performance">+0 EUR (+0%)</span>
        </p>
        <div class="grayLine"></div>
      </div>
    </div>
  ...
  <div class="container ">
    ...
    <div class="row d-md-flex justify-content-md-around">
      <div class="col-md-5 col-12 popUpImg">
        <h1 class="amoount">€ <?php echo number_format($value['investment'] , 0, ',', "."); ?></h1>
        <p class="amountDetail">
          <?php echo number_format(round($value['size']) , 0, ',', ".")." ".$value['project_name']; ?> Token/Shares</p>
          ...
          <div>
            ...
            <p>
              ...
              if($value['tracking_service'] && $value['tracking_id'] && $end_date >= $today) { 
                $url = "#";
                  if($value['tracking_service'] == 1) {
                    $url = "http://ups.com/";
                  } else if ($value['tracking_service'] == 2) {
                    $url = "https://www.dt.post.de/";
                  } else if($value['tracking_service'] == 3) {
                    $url = "http://fedex.com/tracking/";
                  }
                ?>
              <a href="<?= $url ?><?= $value['tracking_id'] ?>"><i class="fa-solid fa-truck-fast fa-beat-fade"
                  style="font-size: 16px;"></i></a>
              <?php } ?>
              <a href="utils/pdfGenerate.php?id=<?= $key ?>&passhash=<?= $hashValue ?>"
          ...
          <div class="userForm">
            <form id="supportTicketForm">
              <div class="mb-3 userInputIconCtrl">
                <input type="text" class="form-control" id="ticketName" placeholder="Name" aria-describedby="emailHelp"
                  required>
              ...
              <div class="mb-3">
                <textarea class="form-control" id="ticketMessage" rows="3" placeholder="" required></textarea>
              </div>
        ...
        <div class="modalContents">
          ...
          <div class="userForm">
            <form id="changePasswordForm">
              ...
              <div class="mb-3 userInputIconCtrl">
                <input type="password" class="form-control" id="newPassword" placeholder="<?= $ln['new_password'] ?>"
                  required>
                <img src="assets/images/lock.png" alt="lock" class="img-fluid">
              </div>
              <div class="mb-3 userInputIconCtrl">
        ...
        <div class="modalContents">
          ...
          <form id="kycUploadForm" action="utils/middle.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="d-flex justify-content-around mb-3 align-items-center">
              ...
              <div class="mt-4">
                <a href="backoffice/uploads/<?= $idFile ? $idFile['file_name'] : "" ?>"
                  style="visibility: <?= ($idFile && $idFile['valid'] != 2) ? "" : "hidden" ?>" target="_blank"
                  title="ID file download" id="id_file_download"><i class="fas fa-download"></i></a>
              </div>
            </div>
            <div class="d-flex justify-content-around mb-3 align-items-center">
              <div class="form-group w-85" style="position: relative;">
              ...
              <div class="mt-4">
                <a href="backoffice/uploads/<?= $utilityFile ? $utilityFile['file_name'] : "" ?>"
                  style="visibility: <?= ($utilityFile && $utilityFile['valid'] != 2) ? "" : "hidden" ?>"
                  target="_blank" title="Utility file download" id="utility_file_download"><i
            ...
            <div class="d-flex justify-content-around mb-3 align-items-center">
              ...
              <div class="mt-4">
                <a href="backoffice/uploads/<?= $ndaFile ? $ndaFile['file_name'] : "" ?>"
                  style="visibility: <?= ($ndaFile && $ndaFile['valid'] != 2) ? "" : "hidden" ?>" target="_blank"
                  title="NDA file download" id="nda_file_download"><i class="fas fa-download"></i></a>
              </div>
            </div>
            ...
            <div class="modal-footer mt-4 pb-0">
              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><?= $ln['cancel'] ?></button>
      ...
      <div class="modal-body">
        <div class="modalContents">
          ...
          <form method="post" id="buyTokenForm" action="utils/middle.php">
            ...
            <div class="modal-footer mt-5 pb-0">
              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><?= $ln['cancel'] ?></button>
              <button type="submit" class="btn btn-primary buy-token" name="buyToken"><?= $ln['confirm_'] ?></button>
            </div>
          </form>
        </div>
      </div>
...
<?php 
  ...
  include_once("layouts/ticker_footer.php");
  ...
  setTimeout(() => {
    ...
    setTimeout(() => {
      ...
      if (AdobeAPI.iframeURL != "") {
        ...
        style="border: 0; overflow: hidden; min-height: 400px; min-width: 600px;"></iframe>`);
