        ...
        <div class="userInfo d-flex align-items-center">
            ...
            <div class="userLeftInfo">
                ...
                <div>
                    ...
                    <button class="btncallsupport btn-sm mt-2" data-bs-toggle='modal'
                        data-bs-target="#kycUploadModal">KYC/NDA
                        Upload</button>
                </div>
            </div>
        </div>
        ...
        <div class="row d-md-flex justify-content-md-around">
            ...
            <div class="col-md-5 col-12 popUpImgTwo">
              ...
              if($value['tracking_service'] && $value['tracking_id'] && $end_date >= $today) { 
                ...
                ?>
                            <a href="<?= $url ?><?= $value['tracking_id'] ?>"><i
                                    class="fa-solid fa-truck-fast fa-beat-fade" style="font-size: 16px;"></i></a>
                            <?php } ?>
                  ...
                  ?>
                            ...
                            <div class="mt-4">
                                <a href="backoffice/uploads/<?= $idFile ? $idFile['file_name'] : "" ?>"
                                    ...
                                    target="_blank" title="ID file download" id="id_file_download"><i
                        ...
                        <div class="d-flex justify-content-around mb-3 align-items-center">
                            ...
                            <div class="mt-4">
                                <a href="backoffice/uploads/<?= $ndaFile ? $ndaFile['file_name'] : "" ?>"
                                    ...
                                    target="_blank" title="NDA file download" id="nda_file_download"><i
                                        class="fas fa-download"></i></a>
                            </div>
                        </div>
