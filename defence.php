...
<!-- Home Begin -->
<section id="defence" class="green-wave-gold page-section py-0">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" id="flight" src="assets/images/slider/denfence1.jpg" alt="First slide" />
                <div class="text-group">
                    <p>DEFENCE</p>
                    <p>The company is specialized in the design and production of advanced products, offering a high
                        degree of vertical integration: from a complex assembly group down to a simple sheet of
                        honeycomb – everything is possible.</p>
                </div>
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" id="trucks" src="assets/images/slider/denfence2.jpg" alt="Second slide" />
                <div class="text-group">
                    <p>DEFENCE</p>
                    <p>The company is specialized in the design and production of advanced products, offering a high
                        degree of vertical integration: from a complex assembly group down to a simple sheet of
            ...
            <div class="carousel-item">
                <img class="d-block w-100" id="space" src="assets/images/slider/denfence3.jpg" alt="Third slide" />
                <div class="text-group">
                    <p>DEFENCE</p>
                    <p>The company is specialized in the design and production of advanced products, offering a high
                        degree of vertical integration: from a complex assembly group down to a simple sheet of
            ...
            <div class="carousel-item">
                <img class="d-block w-100" id="yachts" src="assets/images/slider/defense.jpg" alt="yachts slide" />
                <div class="text-group">
                    <p>DEFENCE</p>
                    <p>The company is specialized in the design and production of advanced products, offering a high
                        degree of vertical integration: from a complex assembly group down to a simple sheet of
    ...
    <div class="content-section">
        <div class="container text-center">
            <div class="header_text">
                <p>Ecological Technologies is a medium-sized manufacturer of lightweight products primarily based on
                    honeycomb core. The company is specialized in the design and production of advanced products,
                    offering a high degree of vertical integration: from a complex assembly group down to a simple sheet
                    of honeycomb – everything is possible.
                </p>
                <p>The production line is designed for just-in-time manufacturing of the highest quality.
                </p>
                <p>Our products include various types of honeycomb core materials, panels, laminates, and formed and
                    milled composites parts, as well as complex drop-in parts for a wide range of industries, but
                    especially for the defence industry.
                </p>
                <p>Our parts stand out due to low weight, high surface quality, and their resistance to steady loads and
                    aggressive environmental conditions. They are geometrically stable due to fiber reinforced skin
                    materials with high specific stiffness and strength with accurate and complex shaping.
                </p>
                <p>
                    For example, these panels can be used for antenna systems, military platform bodies (weapon
                    stations, torsion-free platforms), shipbuilding (interior, walls, covering, radar systems), special
                    mobile containers (shelter, mobile kitchen, military hospitals, supply units), radio telescopes,
                    satellite systems and dishes, and for human and vehicle safety (superstructure parts, loading ramps,
                    interior, radar systems). The honeycomb sheets can also be applied as carrier material for
                    electronic parts and as support for printed circuit boards.
                </p>
                <p>
                    Ecological Technologies is one of only two companies worldwide that produce aviation authorized
                    (high pressure rugged) glass fiber honeycomb.
                </p>
                <p>
                    The extraordinary achievements of ECOLOGICAL TECHNOLOGIES in this area show the drive and will to be
                    a key player in the supply chain of the global defence industry.
                </p>
            </div>
            <div class="content">
                <p>
    ...
    <div class="modal fade" id="assemblies" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h2>Glass Fiber Honeycomb</h2>
                    <p>The glass fiber honeycomb of ECOLOGICAL TECHNOLOGIES® covers all specification requirements that
                        are needed in the aviation industry.
                    </p>
                    <p>EC can combine glass fiber honeycomb with a variety of resins. For example, polyimide and cyanate
                        ester resins can be used to improve high-temperature and radar properties of the product.
                    </p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary">
...
$(function() {
    ...
    $("#flight").addClass("zoomin")
    $('a[href="defence.php"]').parent().parent().parent().addClass("active");
    $('a[href="defence.php"]').parent().siblings().removeClass("active");
    $('.carousel').carousel({
        interval: false,
        ride: true
    })
